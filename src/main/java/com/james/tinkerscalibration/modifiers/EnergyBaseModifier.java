...
public class EnergyBaseModifier{
    /*
    protected final Supplier<? extends IToolStackView> tool;
    private final LazyOptional<IEnergyStorage> capOptional;
    public static final String STORED_ENERGY_KEY = "tooltip.tinkerscalibration.stored_enegry";
    public static final ResourceLocation MAX_ENERGY = new ResourceLocation(TinkersCalibration.MODID, "max_energy");
    public static final ResourceLocation STORED_ENERGY = new ResourceLocation(TinkersCalibration.MODID, "stored_energy");
    public static final ResourceLocation ENERGY_OWNER = new ResourceLocation(TinkersCalibration.MODID, "energy_owner");
    private static final int MAX_TRANSFER_RATE = 100000;

    public EnergyBaseModifier(ItemStack stack, Supplier<? extends IToolStackView> toolStack) {
        this.tool = toolStack;
